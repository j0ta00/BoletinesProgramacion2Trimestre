...
import jugadores.Enum.Smartphones;

enum Nota{ SUSPENSO("Ram贸n",2),SUFICIENTE("Gervasio",5),BIEN("Melania",6),NOTABLE("Isabel",8),SOBRESALIENTE("Jerem铆as",9);
	...
	public static void main(String[] args){
		...
		*/
		...
		switch(movilMatias.getCapacidad()){
			case 64->System.out.println("La capacidad de tu m髒il es de 64 Gb"); 
			case 128->System.out.println("La capacidad de tu m髒il es de 128 Gb");
			case 256->System.out.println("La capacidad de tu m髒il es de 256 Gb");
		}
			
		/*
		//Orden de los m贸viles
		...
		System.out.println("\nEl m贸vil m谩s caro es el "+moviles[auxiliar2].getModelo());
		*/	
	}
